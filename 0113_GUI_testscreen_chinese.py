...
class LoadingBar(RelativeLayout):
    ...
    def __init__(self, total_time, **kwargs):
        ...
        fn_regular="/usr/share/fonts/truetype/wqy/wqy-zenhei.ttc")
    ...
    def update_progress(self, dt):
        ...
        self.time_label.text = f"剩余时间: {mm:02d}:{ss:02d}"
...
class MotorControlScreen(MDScreen):
    ...
    def build_ui(self):
        ...
        back_button = MDButton(
            ...
            MDButtonText(text="返回", font_style="Title"),
            style="elevated",
            size_hint=(None, None),
            size=(dp(100), dp(40)),
        ...
        home_button = MDButton(
            ...
            MDButtonText(text="主页", font_style="Title"),
            style="elevated",
            size_hint=(None, None),
            size=(dp(100), dp(40)),
    ...
    def update_actual_temperature(self, dt):
        ...
        self.temperature_label.text = f"当前温度: {temp:.1f} °C"
